#
# CMPUT 174
# Lab 3 Pong version 2
#
# First name: Yi
# Last name: Yang
# Lab section: H04
#
# Description: This is version 2 of the Pong program
#
#
...
class Ball:
    def __init__(self, dot_color, dot_radius, dot_center, dot_velocity, surface):
        ...
        self.surface = surface
        self.left_paddle_x = 105
        self.left_paddle_y = 180
        self.right_paddle_x = 395
        self.right_paddle_y = 180
        self.paddle_width = 10
        self.paddle_height = 40
        self.left_rect = pygame.Rect(self.left_paddle_x, self.left_paddle_y, self.paddle_width, self.paddle_height)
        self.right_rect = pygame.Rect(self.right_paddle_x, self.right_paddle_y, self.paddle_width, self.paddle_height)
    ...
    def draw(self):
        ...
        pygame.draw.rect(self.surface, self.color, self.left_rect)
        pygame.draw.rect(self.surface, self.color, self.right_rect)
    ...
    def left_paddle_collision(self):
        if self.left_rect.collidepoint(self.center[0], self.center[1]):
            return True

    def right_paddle_collision(self):
        if self.right_rect.collidepoint(self.center[0], self.center[1]):
            return True
