...
class Game:
    ...
    def create_tile(self):
        ...
        for row_index in range(0, self.board_size):
            ...
            for col_index in range(0, self.board_size):
                ...
                a_tile = Tile(x, y, self.pic[image_index], self.cover, self.surface)
                row.append(a_tile)
    ...
    def handle_mouse_up(self, position):
        ...
        for row in self.board:
            for tile in row:
                if tile.select(position) == True:  # select returns True or False
                    pass
...
class Tile:
    ...
    def __init__(self, x, y, image, cover, surface):
        self.image = image
        self.cover = cover
        self.covered = True
        self.surface = surface
    ...
    def draw(self):
        pygame.draw.rect(self.surface, Tile.border_color, self.rect, Tile.border_size)
